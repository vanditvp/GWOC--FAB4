...
function removeProduct(productId) {
  ...
  function createProductElement(product) {
    ...
    closeIcon.classList.add('fa', 'fa-times', 'cart');
...
// Ensure that your event listeners or other parts of your code are appropriately set up
// to call the addProduct function when the form is submitted, etc.
